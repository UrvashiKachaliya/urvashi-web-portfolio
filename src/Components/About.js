...
import "../Styles/About.css";
import image from "../Assets/laptop.avif";
        ...
        <Container>
          <Row>
            <Col lg={7} className="p-5">
              <h1 className="text-black">Let me introduce myself.</h1>
              <div className="content py-4">
  <p>
    <span className="highlight-text fw-bold">Hey Folks</span>, I'm Urvashi Kachaliya, a Software intern with six months of hands-on experience in 
    <span className="highlight-text fw-bold"> HTML, CSS, JavaScript, and React.</span>
  </p>
  <p>
